    ...
    <style>
        ...
        *::after {
        ...
        @media (max-width: 767px) {
            ...
            main > div:first-child .flex.justify-between,
            ...
            main > div:first-child .flex.items-center.gap-3,
            main > div:first-child .no-print.flex,
            main > div:first-child .flex.gap-2 {
                width: 100%;
                flex-wrap: wrap;
            }
